...
public class PenggunaDAO implements ServicePengguna {
    ...
    public void tambahData(ModelPengguna mod_pengguna) {
        ...
        try {
            ...
            st.setString (6, mod_pengguna.getPassword());
//            st.setString (6, generateSHA256(mod_pengguna.getPassword()));
...
//        String sql = "SELECT * FROM pengguna WHERE nama_pengguna='"+model.getNama_pengguna()+"' AND password="+generateSHA256(model.getPassword())+" ";
